...
SELECT
	...
	s.ScenarioName
FROM AdventureWorksDW.FactFinance f
LEFT JOIN AdventureWorksDW.DimDepartmentGroup d ON f.DepartmentGroupKey = d.DepartmentGroupKey
LEFT JOIN AdventureWorksDW.DimScenario s ON f.ScenarioKey = s.ScenarioKey;
...
FROM AdventureWorksDW.DimProduct p
LEFT JOIN AdventureWorksDW.DimProductSubcategory sc 
ON p.ProductSubcategoryKey = sc.ProductSubcategoryKey
LEFT JOIN AdventureWorksDW.DimProductCategory c 
...
FROM AdventureWorksDW.DimEmployee e
LEFT JOIN AdventureWorksDW.DimSalesTerritory t
...
FROM AdventureWorksDW.DimReseller r 
LEFT JOIN AdventureWorksDW.DimGeography g
