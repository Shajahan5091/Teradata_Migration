...
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "08/06/2025",  "domain": "no-domain-provided" }}'
AS
SELECT
	f.FinanceKey,
	f.DateKey,
