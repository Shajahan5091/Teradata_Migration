...
CREATE OR REPLACE TABLE AdventureWorksDW.DimSalesReason
(
...
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;

--
/* <sc-table> AdventureWorksDW.FactResellerSales </sc-table> */
CREATE OR REPLACE TABLE AdventureWorksDW.FactResellerSales
(
     ...
     DueDate DATE,
     ShipDate DATE,
CONSTRAINT FK_FactResellerSales_DimCurrency FOREIGN KEY ( CurrencyKey ) REFERENCES AdventureWorksDW.DimCurrency ( CurrencyKey ),
CONSTRAINT FK_FactResellerSales_DimDate FOREIGN KEY ( OrderDateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactResellerSales_DimDate1 FOREIGN KEY ( DueDateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactResellerSales_DimDate2 FOREIGN KEY ( ShipDateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactResellerSales_DimEmployee FOREIGN KEY ( EmployeeKey ) REFERENCES AdventureWorksDW.DimEmployee ( EmployeeKey ),
CONSTRAINT FK_FactResellerSales_DimProduct FOREIGN KEY ( ProductKey ) REFERENCES AdventureWorksDW.DimProduct ( ProductKey ),
CONSTRAINT FK_FactResellerSales_DimPromotion FOREIGN KEY ( PromotionKey ) REFERENCES AdventureWorksDW.DimPromotion ( PromotionKey ),
CONSTRAINT FK_FactResellerSales_DimReseller FOREIGN KEY ( ResellerKey ) REFERENCES AdventureWorksDW.DimReseller ( ResellerKey ),
CONSTRAINT FK_FactResellerSales_DimSalesTerritory FOREIGN KEY ( SalesTerritoryKey ) REFERENCES AdventureWorksDW.DimSalesTerritory ( SalesTerritoryKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimScenario
(
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactProductInventory
(
     ProductKey INTEGER NOT NULL,
...
CONSTRAINT FK_FactProductInventory_DimDate FOREIGN KEY ( DateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactProductInventory_DimProduct FOREIGN KEY ( ProductKey ) REFERENCES AdventureWorksDW.DimProduct ( ProductKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactFinance
(
...
CONSTRAINT FK_FactFinance_DimScenario FOREIGN KEY ( ScenarioKey ) REFERENCES AdventureWorksDW.DimScenario ( ScenarioKey ),
CONSTRAINT FK_FactFinance_DimOrganization FOREIGN KEY ( OrganizationKey ) REFERENCES AdventureWorksDW.DimOrganization ( OrganizationKey ),
CONSTRAINT FK_FactFinance_DimDepartmentGroup FOREIGN KEY ( DepartmentGroupKey ) REFERENCES AdventureWorksDW.DimDepartmentGroup ( DepartmentGroupKey ),
CONSTRAINT FK_FactFinance_DimDate FOREIGN KEY ( DateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactFinance_DimAccount FOREIGN KEY ( AccountKey ) REFERENCES AdventureWorksDW.DimAccount ( AccountKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimGeography
(
...
CONSTRAINT FK_DimGeography_DimSalesTerritory FOREIGN KEY ( SalesTerritoryKey ) REFERENCES AdventureWorksDW.DimSalesTerritory ( SalesTerritoryKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactInternetSalesReason
(
     SalesOrderNumber VARCHAR(20) NOT NULL,
...
SalesOrderLineNumber ) REFERENCES AdventureWorksDW.FactInternetSales ( SalesOrderNumber ,
SalesOrderLineNumber ),
CONSTRAINT FK_FactInternetSalesReason_DimSalesReason FOREIGN KEY ( SalesReasonKey ) REFERENCES AdventureWorksDW.DimSalesReason ( SalesReasonKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimEmployee
(
     EmployeeKey INTEGER NOT NULL,
...
CONSTRAINT FK_DimEmployee_DimSalesTerritory FOREIGN KEY ( SalesTerritoryKey ) REFERENCES AdventureWorksDW.DimSalesTerritory ( SalesTerritoryKey ),
CONSTRAINT FK_DimEmployee_DimEmployee FOREIGN KEY ( ParentEmployeeKey ) REFERENCES AdventureWorksDW.DimEmployee ( EmployeeKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimCurrency
(
     CurrencyKey INTEGER NOT NULL,
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimSalesTerritory
(
     SalesTerritoryKey INTEGER NOT NULL,
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimDepartmentGroup
(
     DepartmentGroupKey INTEGER NOT NULL,
     ParentDepartmentGroupKey INTEGER,
     DepartmentGroupName VARCHAR(50),
PRIMARY KEY ( DepartmentGroupKey ),
CONSTRAINT FK_DimDepartmentGroup_DimDepartmentGroup FOREIGN KEY ( ParentDepartmentGroupKey ) REFERENCES AdventureWorksDW.DimDepartmentGroup ( DepartmentGroupKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimReseller
(
     ResellerKey INTEGER NOT NULL,
...
CONSTRAINT FK_DimReseller_DimGeography FOREIGN KEY ( GeographyKey ) REFERENCES AdventureWorksDW.DimGeography ( GeographyKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.ProspectiveBuyer
(
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactCurrencyRate
(
     CurrencyKey INTEGER NOT NULL,
     DateKey INTEGER NOT NULL,
...
CONSTRAINT FK_FactCurrencyRate_DimDate FOREIGN KEY ( DateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactCurrencyRate_DimCurrency FOREIGN KEY ( CurrencyKey ) REFERENCES AdventureWorksDW.DimCurrency ( CurrencyKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;

--
/* <sc-table> AdventureWorksDW.NewFactCurrencyRate </sc-table> */
CREATE OR REPLACE TABLE AdventureWorksDW.NewFactCurrencyRate
(
...
CREATE OR REPLACE TABLE AdventureWorksDW.FactInternetSales
(
     ProductKey INTEGER NOT NULL,
     OrderDateKey INTEGER NOT NULL,
     DueDateKey INTEGER NOT NULL,
     ...
     DueDate DATE,
     ShipDate DATE,
CONSTRAINT FK_FactInternetSales_DimCurrency FOREIGN KEY ( CurrencyKey ) REFERENCES AdventureWorksDW.DimCurrency ( CurrencyKey ),
CONSTRAINT FK_FactInternetSales_DimDate FOREIGN KEY ( OrderDateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactInternetSales_DimDate1 FOREIGN KEY ( DueDateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactInternetSales_DimDate2 FOREIGN KEY ( ShipDateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ),
CONSTRAINT FK_FactInternetSales_DimProduct FOREIGN KEY ( ProductKey ) REFERENCES AdventureWorksDW.DimProduct ( ProductKey ),
CONSTRAINT FK_FactInternetSales_DimPromotion FOREIGN KEY ( PromotionKey ) REFERENCES AdventureWorksDW.DimPromotion ( PromotionKey ),
CONSTRAINT FK_FactInternetSales_DimSalesTerritory FOREIGN KEY ( SalesTerritoryKey ) REFERENCES AdventureWorksDW.DimSalesTerritory ( SalesTerritoryKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
CONSTRAINT FK_DimProductSubcategory_DimProductCategory FOREIGN KEY ( ProductCategoryKey ) REFERENCES AdventureWorksDW.DimProductCategory ( ProductCategoryKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimAccount
(
     AccountKey INTEGER NOT NULL,
...
CONSTRAINT FK_DimAccount_DimAccount FOREIGN KEY ( ParentAccountKey ) REFERENCES AdventureWorksDW.DimAccount ( AccountKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimProductCategory
(
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimDate
(
     DateKey INTEGER NOT NULL,
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactSalesQuota
(
...
CONSTRAINT FK_FactSalesQuota_DimEmployee FOREIGN KEY ( EmployeeKey ) REFERENCES AdventureWorksDW.DimEmployee ( EmployeeKey ),
CONSTRAINT FK_FactSalesQuota_DimDate FOREIGN KEY ( DateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactCallCenter
(
...
CONSTRAINT FK_FactCallCenter_DimDate FOREIGN KEY ( DateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimPromotion
(
     PromotionKey INTEGER NOT NULL,
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimOrganization
(
     OrganizationKey INTEGER NOT NULL,
...
CONSTRAINT FK_DimOrganization_DimCurrency FOREIGN KEY ( CurrencyKey ) REFERENCES AdventureWorksDW.DimCurrency ( CurrencyKey ),
CONSTRAINT FK_DimOrganization_DimOrganization FOREIGN KEY ( ParentOrganizationKey ) REFERENCES AdventureWorksDW.DimOrganization ( OrganizationKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactSurveyResponse
(
...
CONSTRAINT FK_FactSurveyResponse_DateKey FOREIGN KEY ( DateKey ) REFERENCES AdventureWorksDW.DimDate ( DateKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.FactAdditionalInternationalProductDescription
(
     ProductKey INTEGER NOT NULL,
...
--** SSC-FDM-TD0024 - SET TABLE FUNCTIONALITY NOT SUPPORTED. TABLE MIGHT HAVE DUPLICATE ROWS **
CREATE OR REPLACE TABLE AdventureWorksDW.DimProduct
(
     ProductKey INTEGER NOT NULL,
...
CONSTRAINT FK_DimProduct_DimProductSubcategory FOREIGN KEY ( ProductSubcategoryKey ) REFERENCES AdventureWorksDW.DimProductSubcategory ( ProductSubcategoryKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/02/2025",  "domain": "no-domain-provided" }}'
;