...
CONSTRAINT FK_DimGeography_DimSalesTerritory FOREIGN KEY ( SalesTerritoryKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimSalesTerritory ( SalesTerritoryKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/04/2025",  "domain": "no-domain-provided" }}'
;
...
CONSTRAINT FK_DimEmployee_DimSalesTerritory FOREIGN KEY ( SalesTerritoryKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimSalesTerritory ( SalesTerritoryKey ),
CONSTRAINT FK_DimEmployee_DimEmployee FOREIGN KEY ( ParentEmployeeKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimEmployee ( EmployeeKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/04/2025",  "domain": "no-domain-provided" }}'
;
...
CONSTRAINT FK_DimReseller_DimGeography FOREIGN KEY ( GeographyKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimGeography ( GeographyKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/04/2025",  "domain": "no-domain-provided" }}'
;
...
CONSTRAINT FK_DimAccount_DimAccount FOREIGN KEY ( ParentAccountKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimAccount ( AccountKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/04/2025",  "domain": "no-domain-provided" }}'
;
...
CONSTRAINT FK_DimOrganization_DimCurrency FOREIGN KEY ( CurrencyKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimCurrency ( CurrencyKey ),
CONSTRAINT FK_DimOrganization_DimOrganization FOREIGN KEY ( ParentOrganizationKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimOrganization ( OrganizationKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/04/2025",  "domain": "no-domain-provided" }}'
;
...
CONSTRAINT FK_FactSurveyResponse_DateKey FOREIGN KEY ( DateKey ) REFERENCES ADVENTUREWORKSDW.SNOWCONVERT.DimDate ( DateKey ))
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 7,  "patch": "0.0" }, "attributes": {  "component": "teradata",  "convertedOn": "06/04/2025",  "domain": "no-domain-provided" }}'
;
